...
%     transposedConv2dLayer(filterSize,8*numFilters,Stride=2,Cropping="same")
%     batchNormalizationLayer
%     reluLayer
%     transposedConv2dLayer(filterSize,4*numFilters,Stride=2,Cropping="same")
%     batchNormalizationLayer
...
%% 
% If t2he discriminator learns to discriminate between real and generated images 
...
%% 
% Convert the data to |dlarray| objects and specify the format |"CB"| (channel, tic
% batch).
...
% the generator state, and the network scores using |dlfeval| and tload("long1_state.mat");
...
%             learnRate/8, gradientDecayFactor, squaredGradientDecayFactor);
